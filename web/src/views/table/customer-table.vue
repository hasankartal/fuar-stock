<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="Soyad" width="110px" align="center">
        <template slot-scope="{row}">
...
export default {
  ...
  methods: {
    ...
    getSearchList() {
      ...
      fetchCustomerSearchList(this.listQuery).then(response => {
        console.log(response)
        this.list = response.map(v => {
            v.id = v.id
            return v
