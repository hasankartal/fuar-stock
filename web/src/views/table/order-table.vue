<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="Satış No" width="110px" align="center">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="90px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="Satış No" prop="saleId">
          <el-select v-model="temp.saleId" style="width: 140px" class="filter-item" >
            <el-option v-for="item in sale" :key="item.id" :label="item.value" :value="item.id" />
          </el-select>
        </el-form-item>

        <el-form-item label="Müşteri" prop="saleId">
...
<script>
import { fetchPv, fetchSaleList , fetchCustomerList, fetchOrderList, fetchOrderSearchList ,createOrder, updateOrder, deleteOrder, exportOrderExcel, exportOrderExcelByParameters } from '@/api/article'
...
export default {
  ...
  methods: {
    ...
    getSearchList() {
      ...
      fetchOrderSearchList(this.listQuery).then(response => {
        console.log(response)
        this.list = response.map(v => {
            v.id = v.id
            return v
